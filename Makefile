...
RTRS: raylib
ifneq (,$(RTRS_config))
	@echo "==== Building RTRS ($(RTRS_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f RTRS.make config=$(RTRS_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f RTRS.make clean
